...
###3.1 - chamada de função usando o type , int, str, o
# type eh para identificar o numero e palavra e o int usado para
# mostrar o valor sem o ponto flutuante e o float mostrar varios ponto flutuante
